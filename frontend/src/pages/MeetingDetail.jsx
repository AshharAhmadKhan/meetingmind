...
const s = {
  ...
  healthScoreRow: { display:'flex', alignItems:'baseline', gap:4, marginBottom:6 },
  healthNum:   { fontFamily:"'Playfair Display',serif", fontSize:52, fontWeight:700,
                 color:'#c8f04a', lineHeight:1 },
  healthDenom: { fontSize:18, color:'#4a4a3e', fontFamily:"'Playfair Display',serif" },
