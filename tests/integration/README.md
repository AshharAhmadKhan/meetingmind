...
Comprehensive integration test suite for MeetingMind.
...
tests/integration/
├── README.md              # This file
├── run-ci-tests.py        # Main CI/CD test runner
...
└── [other test scripts]   # Additional integration tests
```
...
```bash
python tests/integration/core/comprehensive-test-suite.py
```

### Create Test Meeting
```bash
python tests/integration/core/create-comprehensive-test-meeting.py
```
...
python tests/integration/api/test-api-endpoint.py

# Verify features
python tests/integration/features/test-debt-dashboard.py
python tests/integration/features/test-graveyard-data.py
```
...
python tests/integration/test-concurrent-requests.py
```

### Latency Testing
```bash
# Measure API response times
python tests/integration/test-api-latency.py
```
...
```bash
# Test JWT validation
python tests/integration/test-auth-validation.py
```

### Authorization Testing
```bash
# Test team member access
python tests/integration/test-team-member-access.py
```
