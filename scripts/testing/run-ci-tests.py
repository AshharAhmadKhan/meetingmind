...
def main():
    ...
    suite.run_test(
        ...
        "scripts/testing/core/comprehensive-test-suite.py",
    ...
    suite.run_test(
        "List Meetings API",
        "scripts/testing/api/test-list-meetings-api.py",
        critical=True
    )
    suite.run_test(
        "Get Meeting Lambda",
        "scripts/testing/test-get-meeting-lambda.py",
        critical=True
    )
    suite.run_test(
        "Update Action API",
        "scripts/testing/test-update-action-team-member.py",
        critical=True
    )
    suite.run_test(
        "Get All Actions API",
        "scripts/testing/test-get-all-actions-quick.py",
        critical=True
    )
    suite.run_test(
        "Team Meetings API",
        "scripts/testing/api/test-team-meetings-api.py",
        critical=True
    )
    suite.run_test(
        "Debt Analytics API",
        "scripts/testing/api/test-debt-api-call.py",
        critical=True
    )
    ...
    suite.run_test(
        ...
        "scripts/testing/test-current-health-roi.py",
        critical=True
    )
    suite.run_test(
        "Meeting Rating Formula",
        "scripts/testing/features/verify-meeting-rating-formula.py",
        critical=True
    )
    suite.run_test(
        "Debt Dashboard Calculations",
        "scripts/testing/features/test-debt-dashboard.py",
        critical=True
    )
    suite.run_test(
        "Graveyard Data Integrity",
        "scripts/testing/features/test-graveyard-data.py",
        critical=True
    )
    ...
    suite.run_test(
        ...
        "scripts/testing/test-team-member-access.py",
        critical=True
    )
    suite.run_test(
        "Team Filtering & Isolation",
        "scripts/testing/test-team-filtering.py",
        critical=True
    )
    ...
    suite.run_test(
        ...
        "scripts/testing/core/verify-test-meeting.py",
        critical=True
    )
    suite.run_test(
        "Team Data Integrity",
        "scripts/testing/check-teams.py",
        critical=True
    )
    suite.run_test(
        "Meeting Format Consistency",
        "scripts/testing/core/compare-meeting-formats.py",
        critical=True
    )
    suite.run_test(
        "Account Access Check",
        "scripts/testing/check-all-accounts.py",
        critical=True
    )
    ...
    suite.run_test(
        "Duplicate Detection",
        "scripts/testing/features/test-duplicate-detection.py",
        critical=False
    )
    suite.run_test(
        "View Invite Code",
        "scripts/testing/features/test-view-invite-code.py",
        critical=False
    )
    suite.run_test(
        "Graveyard Data Check",
        "scripts/testing/features/check-graveyard-data.py",
        critical=False
    )
    suite.run_test(
        "Duplicate Lambda Direct",
        "scripts/testing/features/test-duplicate-lambda-direct.py",
        critical=False
    )
    ...
    suite.run_test(
        ...
        "scripts/testing/check-aws-account.py",
        critical=False
    )
    suite.run_test(
        "Bedrock Status",
        "scripts/testing/check-bedrock-status.py",
        critical=False
    )
    suite.run_test(
        "CloudFront Cache Status",
        "scripts/testing/check-cloudfront-cache.py",
        critical=False
    )
